...
async def lifespan(_app: FastAPI):
    """Abre el puerto ya; GraphRAG/hnswlib se cargan en la primera consulta."""
...
# GraphRAG/hnswlib se cargan en la primera consulta (no en startup: SIGILL 132 en Render).
_grag = None
_orchestrator = None
